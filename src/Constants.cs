...
namespace src
{
    ...
    {
        public static readonly Dictionary<string, int> challengeRatings = new Dictionary<string, int>()
        { { "CR0", 10 }, { "CR1/8", 25 }, { "CR1/4", 50 }, { "CR1/2", 100 }, { "CR1", 200 }, { "CR2", 450 }, { "CR3", 700 }, { "CR4", 1_100 }, { "CR5", 1_800 }, { "CR6", 2_300 }, { "CR7", 2_900 }, { "CR8", 3_900 }, { "CR9", 5_000 }, { "CR10", 5_900 }, { "CR11", 7_200 }, { "CR12", 8_400 }, { "CR13", 10_000 }, { "CR14", 11_500 }, { "CR15", 13_000 }, { "CR16", 15_500 }, { "CR17", 18_000 }, { "CR18", 20_000 }, { "CR19", 22_000 }, { "CR20", 25_000 }, { "CR21", 30_000 }, { "CR22", 41_000 }, { "CR23", 50_000 }, { "CR24", 62_000 }, { "CR25", 75_000 }, { "CR26", 90_000 }, { "CR27", 105_000 }, { "CR28", 120_000 }, { "CR29", 135_000 }, { "CR30", 155_000 }
        };

        public static readonly Dictionary<int, ExperienceThreshold> RankMapping = new Dictionary<int, ExperienceThreshold>()
